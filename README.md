...
| AWSWatcher Lab        | [Link](writeups/cyberdefenders/cloud-forensics/easy/awswatcher-lab.md)          | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/awswatcher/)        | Easy       | ⭐⭐     | `CloudTrail`     |
