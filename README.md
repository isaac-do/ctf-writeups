...
| ---------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ---------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| Spooler - APT28 Lab                | [Link](writeups/cyberdefenders/endpoint-forensics/hard/spooler-apt28-lab.md)           | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/spooler-apt28/)                | Hard       | ⭐⭐⭐⭐   | `Registry Explorer` `Timeline Explorer` `DB Browser for SQLite` `MFTECmd` `PECmd` `MITRE ATT&CK` `Event Log Explorer` `VirusTotal` |
| KioskExpo7 Lab                     | HIDDEN (Active Lab)                                                                    | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/kioskexpo7/)                   | Medium     | ⭐⭐⭐    | `DB Browser for SQLite` `Registry Explorer`                                                                                        |
| CursorJack Lab                     | HIDDEN (Active Lab)                                                                    | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/cursorjack/)                   | Easy       | ⭐⭐     | `DB Browser for SQLite` `Notepad++` `Event Log Explorer` `Sysmon` `TrailInspector`                                                 |
...
| Name                            | Writeup                                                                           | Challenge                                                                                       | Difficulty | Rating | Tags                                                   |
| ------------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ---------- | ------ | ------------------------------------------------------ |
| RCEMiner Lab                    | [Link](writeups/cyberdefenders/network-forensics/medium/rceminer-lab.md)          | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/rceminer/)                  | Medium     | ⭐⭐⭐    | `Wireshark`                                            |
...
| Name                      | Writeup                                                                         | Challenge                                                                                 | Difficulty | Rating | Tags                           |
| ------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | ---------- | ------ | ------------------------------ |
| AbuSESer - Trufflenet Lab | HIDDEN <br>(Active Lab)                                                         | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/abuseser-trufflenet/) | Easy       | ⭐⭐     | `CloudWatch`                   |
| Rogue Azure Lab           | HIDDEN <br>(Active Lab)                                                         | [CyberDefenders](https://cyberdefenders.org/blueteam-ctf-challenges/rogue-azure/)         | Easy       | ⭐⭐     | `Microsoft Sentinel`           |
