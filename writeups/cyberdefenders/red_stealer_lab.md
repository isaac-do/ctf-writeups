...
Navigate to **Behavior > Network Communication** then search for a domain name resembling a social media website. Based on the DNS Resolutions, we see f`acebook.com` was resolved via DNS queries.  
